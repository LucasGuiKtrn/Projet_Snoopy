...
// le fait qu'elle rebondis sur les bords de la carte ça fonctionne à peu près. J'ai aussi trouvé un
// moyen pour qu'elle apparaise bien en temps qu'emoji comme demandé.
// Il me restera à faire ce qui est collision avec Snoopy, l'affichage du GAME OVER en cas de collision
// et le non-effaçage des obstacles sur lesquels elle pase.
// Pou l'instant je l'ai mis en commentaire pour être sûr que ça n'affecte pas le reste du programme
// (les // avancés en début de ligne sont à enlever, pas les autres)
